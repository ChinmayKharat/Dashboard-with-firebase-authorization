...
import CircularProgress from "../components/CircularProgress/Circular";
      ...
      <div className="row tall-square inv-bg">
        ...
        <div className="admin">
          ...
          <div className="info">
            ...
            <span className="admin-about">React Js & React Native Developer</span>
          </div>

          <div className="admin-socials">
            
            <Card Icon={FaWhatsapp} onClick='https://wa.link/xeezas' />
